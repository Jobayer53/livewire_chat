    ...
    <!-- <nav class="navbar">
        <div class="container">
            <span class="navbar-brand">
                <i class="fas fa-comments me-2"></i>Disting Disting
            </span>
        </div>
    </nav> -->
        ...
        <div class="container">
            <div class="header-content text-center">
                ...
                <div class="privacy-notice">
                    ...
                    <strong>Privacy First:</strong> No registration required • No data stored • Complete anonymity
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="main-content">
        <div class="content-header">
            <div class="container text-center">
                <h2 class="h4 mb-0">Terms of Service Agreement</h2>
                <p class="text-muted mt-2">Please read these terms carefully before using our service</p>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="meta-info">
                            <div class="row">
                                <div class="col-md-6">
                                    <strong>Last Updated:</strong> June 7, 2025
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="highlight-box">
                            ...
                            <ul class="mb-0">
                                ...
                                <li>No conversation logs or message history stored</li>
                                <li>No user tracking, analytics, or data collection</li>
                                <li>Automatic message deletion upon user disconnection</li>
                            </ul>
                        </div>

                        <!-- User Obligations -->
                        <h3 class="section-title">3. User Obligations</h3>
                        <div class="section-content">
