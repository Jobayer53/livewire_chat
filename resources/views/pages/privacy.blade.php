    ...
    <div class="container-fluid">
        <div class="privacy-container">
            <div class="privacy-header">
                ...
                <p class="mb-0 mt-2 opacity-75">How we protect your privacy while you chat</p>
            </div>
            ...
            <div class="privacy-content">
                ...
                <ul>
                    ...
                    <li>No chat logs are maintained after sessions end</li>
                    <li>Messages cannot be recovered once both users have left the chat</li>
                    <li>No conversation history is available to review</li>
                </ul>

                <h3 class="section-title">3. How We Use Your Information</h3>
                <p>The limited information we collect is used solely for:</p>
                <ul>
                    <li>Facilitating real-time chat connections between users</li>
                    <li>Maintaining chat session stability and functionality</li>
                    <li>Preventing spam and abuse of the platform</li>
                    <li>Basic analytics to improve service performance (anonymized)</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Automatic data deletion protocols</li>
                </ul>

                <h3 class="section-title">7. Your Rights and Choices</h3>
                ...
                <ul>
                    <li><strong>Email:</strong> distingdistingchat@gmail.com</li>
