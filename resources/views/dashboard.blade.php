                        ...
                        <li class="nav-item" title="Chats">
                            <a class="nav-link active chat-nav" href="#pills-chat" id="pills-chat-tab"
                                data-bs-toggle="pill" role="tab" aria-selected="false"><i
                                    class="bi bi-chat-right-text-fill fs-5 me-2"></i> <span>Chats</span></a>
                        </li>
            ...
            <div class="tab-content" id="myTab" role="tablist">
                ...
                <div class="tab-pane overflow-hidden profile-tab" id="pills-user" role="tabpanel"
                    ...
                    <div class="text-center p-4 py-lg-0 mt-n5">
                        ...
                        <h6 class="font-16 mb-1 text-truncate">{{ auth()->user()->name }} &middot;
                            {{ auth()->user()->age }} &middot; <img
                                src="https://flagsapi.com/{{ auth()->user()->country }}/flat/32.png"> </h6>
                                                    ...
                                                    <div class="card rounded-3 shadow-none">
                                                        ...
                                                        @endphp
                                                            <div id="profile" >
                                                                ...
                                                                <button type="button"
                                                                    class="btn bg-transparent btn-sm p-0 d-flex justify-content-center align-items-centergap-2 ms-auto" id="editBtn" >
