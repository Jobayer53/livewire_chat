...
<div>
    ...
    <form wire:submit.prevent="register">
        <div class="row g-3">
            <div class="col-lg-12">
                <div>
                    <input type="text" class="form-control font-14" placeholder="Nickname" wire:model.defer="name"
                        id="name" name="name" required autofocus value="{{ old('name') }}">
                    @error('name')
                        <p class="mt-2 mb-0 float-start text-sm text-danger">{{ $message }}</p>
                    @enderror
                </div>
            </div>
            <div class="col-lg-4">
                <div>
                    <input type="number" class="form-control font-14" id="age" placeholder="Age 18+"
                        min="18" wire:model.defer="age" name="age" required value="{{ old('age') }}">
                    @error('age')
                        <p class="mt-2 mb-0 float-start text-sm text-danger">{{ $message }}</p>
                    @enderror
            ...
            <div class="col-lg-8">
                <div class="form-control d-flex justify-content-evenly">
                    ...
                    <div>
                        <input type="radio" id="Female" name="gender" value="Female" wire:model.defer="gender" />
            ...
            <div class="col-lg-12">
                <select wire:model.defer="country" name="country" class="form-control" id="">
